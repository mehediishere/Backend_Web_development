...
<body>
    ...
    <div class="container" style="margin-top: 50px;">
        <form class="text-center" action="db_delete_and_reset.php" method="POST">
            <input type="text" name="id" placeholder="id" class="form-control" required><br>
            <button class="btn btn-light" name="btn_insert" type="submit" style="margin-top: 5px;">DELETE & RESET</button>
        </form>
    </div>
